...
namespace UPC_Shipment_Manager_UI.UserControls.Shipment
{
	partial class UC_COD
	{
		...
		private void InitializeComponent()
		{
			...
			this.trackingIdDataGridViewTextBoxColumn.Width = 81;
			// 
			...
			this.courierNameDataGridViewTextBoxColumn.Width = 94;
			// 
			...
			this.itemNameDataGridViewTextBoxColumn.Width = 82;
			// 
			...
			this.itemConditionDataGridViewTextBoxColumn.Width = 101;
			// 
			...
			this.remarksDataGridViewTextBoxColumn.Width = 75;
			// 
			...
			this.shipmentTypeDataGridViewTextBoxColumn.Width = 99;
			// 
			...
			this.paymentTypeDataGridViewTextBoxColumn.Width = 101;
			// 
